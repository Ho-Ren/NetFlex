...
<div class ="container">
<h3 class="text-center">Information entered is invalid please make sure your information is correct.</H3>
 <a href ="/login2/checkout.jsp" class="text-center"> <H5>Return to checkout</H5></a>
</div>
</body>
</html>