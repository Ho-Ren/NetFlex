	         		...
	         		content:{
	             		...
	             		url : '/login2/servlet/getMovieInfo',
	          			...
	          			success : function(responseText,status) {
							...
							content += "<form id='login-form' ACTION='/login2/servlet/Carthandler' METHOD='POST'> <input type='hidden' name='moviename' value='${mlist.title}'/>"+
...
/* 					   		content += "<a href = '" + responseText[0].trailer +"'>Trailer </a>";
 */					   			
					   			
					   			
					   		/* 	"<div class = 'line'> <button type='button' class='btn btn-default btn-lg'>"+
					   	  "<span class='glyphicon glyphicon-film' aria-hidden='true'></span> Trailer </button></a> </div>"; */
