...
<p>Please enter the following information to create a new star.</p>
<form id="login-form" class="col-md-6 offset-md-3 "
		...
		<div class="main-login-form">
			<div class="login-group">
				...
				<div class="form-group">
					<label>Photo_url</label> <input type="text" class="form-control"
						name="photo" placeholder="Enter Photo's url">
				</div>
			</div>
			<button class="btn" type="submit">Add Star</button>
		</div>
	</form>
